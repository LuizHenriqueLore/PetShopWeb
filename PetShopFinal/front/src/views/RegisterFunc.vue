        ...
        <section>
            <div class="register-section">
                <div class="register-card">
                    <h3 class="register-page-title">Registrar Funcionario</h3>
                    ...
                    <button @click="create" class="register-btn">Cadastrar Funcionario</button>
                </div>
            </div>
        </section>
    </body>
...
export default {
    ...
    methods: {
        async create() {
            try{
                await axios.post(`http://localhost:3000/funcionario`,
                    {
                        name: this.name,
